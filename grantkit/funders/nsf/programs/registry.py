...
class ProgramRegistry:
    ...
    def _load_builtin_programs(self) -> None:
        ...
        logger.info(
            f"Loaded {len(self.programs)} built-in program configurations"
        )
    ...
    def load_from_yaml(self, yaml_path: Path) -> None:
        ...
        try:
            ...
            raise ValueError(
                f"Failed to load program config from {yaml_path}: {e}"
            )
...
"""
        ...
        budget_template = {
            ...
            "C_fringe": [{"description": "Fringe benefits", "amount": 27500}],
            "E_travel": [
                {
            ...
            "I_indirect": [{"rate": config.indirect_rate_max}],
        }
